...
export default function GoogleSignInButton({
  ...
  const baseStyles =
    "w-full flex items-center justify-center gap-3 rounded-full px-6 py-3 text-base font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed";
